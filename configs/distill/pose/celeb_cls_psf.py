...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations_train.json',
    ...
    val=dict(
        type='FaceCenterDataset',
        ann_file=f'/root/caixin/data/celebrity_center/annotations_test.json',
        img_prefix=f'/mnt/workspace/RawSense/data/celebrity/',
        data_cfg=data_cfg,
