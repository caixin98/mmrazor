...
teacher_ckpt = "/root/caixin/RawSense/nolens_face_align/logs/a_no_optical_face/vit_retina_test_wflw1_no_optical_warmup/epoch_580.pth"
...
data = dict(
    ...
    val=dict(
        type='FaceCenterDataset',
        ann_file=f'/mnt/workspace/RawSense/data/wflw/annotations_single_point/face_landmarks_wflw_test.json',
