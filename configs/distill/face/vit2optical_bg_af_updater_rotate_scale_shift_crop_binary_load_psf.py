...
resume_from = "logs/distill/face/vit2optical_bg_af_updater_rotate_scale_shift_crop_binary_fix/epoch_80.pth"
optical = dict(
    type='LoadPsf',
    ...
    binary=True,
    load_psf_path = "logs/distill/face/vit2optical_bg_af_updater_rotate_scale_shift_crop_binary_fix/visualizations/66400_psf.png",
    n_psf_mask=1)
