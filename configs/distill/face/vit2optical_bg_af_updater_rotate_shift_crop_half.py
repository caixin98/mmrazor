...
train_pipeline = [
            ...
            dict(type='AddBackground', img_dir='/mnt/workspace/RawSense/data/BG-20k/train',size = (200, 200)),
...
val_pipeline = [
            ...
            dict(type='AddBackground', img_dir='/mnt/workspace/RawSense/data/BG-20k/testval',size = (200, 200),is_tensor=True),
