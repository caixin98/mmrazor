...
train_pipeline = [
            ...
            dict(type='RandomFlip', flip_prob=1, direction='vertical'),
            dict(
                type='Propagated',
                mask2sensor=0.002,
                scene2mask=0.4,
...
resume_from = "logs/distill/face/vit2optical_bg_af_updater_rotate_scale_shift_crop_binary_fix/epoch_50.pth"
optical = dict(
    type='LoadPsf',
