...
data = dict(
    ...
    test=dict(
        ...
        pipeline=[
            ...
            dict(type="TorchAffineRTS",keys = ["img1"], angle=(0,30),prob=1.0),
            dict(type="TorchAffineRTS",keys = ["img2"], angle=(0,30),prob=1.0),
    ...
    train_dataloader=dict(samples_per_gpu=140, persistent_workers=False),
