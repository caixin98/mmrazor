...
cls_checkpoint = "logs/distill/face/vit2optical_bg_af_updater_rotate_scale_shift_crop_binary/latest.pth"
pose_checkpoint = "logs/pose_with_cls_data/celeb_bg_cls_psf/latest.pth"
