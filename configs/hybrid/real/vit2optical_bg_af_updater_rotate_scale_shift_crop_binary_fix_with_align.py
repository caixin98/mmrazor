...
data = dict(
    ...
    test=dict(
        type='LFW',
            load_pair = False,
            use_flip = False,
            img_prefix='/root/caixin/data/raw_lfw/Cam20231114/prosessed',
            pair_file='/mnt/workspace/RawSense/data/lfw/pairs.txt',
...
cls_checkpoint = "logs/distill/face/vit2optical_bg_af_updater_rotate_scale_shift_crop_binary_real_psf/latest.pth"
